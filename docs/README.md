...
- [findings-2026-09-04-fragments.md](./findings-2026-09-04-fragments.md) —
  「テキスト断片」の正体は添付画像のバイト列だった。8,199 件中フィルタを
  通るのは 1 件だけで、それも本文ではない。通常表示から外して `?debug=1`
  限定にし、`stringFilter.ts` を削除
